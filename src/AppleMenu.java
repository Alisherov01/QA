...
public class AppleMenu {
    ...
    public static void appleMenu(Company apple) {
            Scanner in = new Scanner(System.in);
            Holding holding = new Holding();
            Employee[] employees = new Employee[10];
            Employee[] employees2 = new Employee[10];
            Company company = new Company("Apple",employees,700000,"Martin");

            Company companyApp = new Company("Apple",employees,700000,"Martin");
            ...
            while (true) {
                ...
                if (command == 1) {
                    System.out.println("---------------------------------");
                    System.out.println(companyApp.getName() + " | " + companyApp.getManagersName() + " | " + companyApp.getCompanyBudget());
                    System.out.println("---------------------------------");
                } else if (command == 2) {
